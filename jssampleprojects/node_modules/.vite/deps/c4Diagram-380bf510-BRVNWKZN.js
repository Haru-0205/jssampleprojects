...
// node_modules/mermaid/dist/c4Diagram-380bf510.js
var qt = function() {
...
function I(e, t, r, o, l2) {
  if (!t[e].width)
    if (r)
      t[e].text = F0(t[e].text, l2, o), t[e].textLines = t[e].text.split(Fn.lineBreakRegex).length, t[e].width = l2, t[e].height = A0(t[e].text, o);
    else {
      ...
      for (const s of n)
        t[e].width = Math.max(
          ir(s, o),
          t[e].width
        ), a = A0(s, o), t[e].height = t[e].height + a;
    }
}
...
//# sourceMappingURL=c4Diagram-380bf510-BRVNWKZN.js.map
